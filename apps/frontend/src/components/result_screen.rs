...
fn conquest_style(pct: u32) -> (&'static str, &'static str) {
    match pct {
        0..=30  => ("#4a7090", "none"),
        31..=55 => ("#00f5ff", "0 0 6px rgba(0,245,255,0.7), 0 0 14px rgba(0,245,255,0.35)"),
        56..=80 => ("#ff00ff", "0 0 8px rgba(255,0,255,0.8), 0 0 18px rgba(255,0,255,0.4)"),
        _       => ("#ffd700", "0 0 10px rgba(255,215,0,0.9), 0 0 24px rgba(255,215,0,0.5), 0 0 40px rgba(255,215,0,0.2)"),
    }
}
